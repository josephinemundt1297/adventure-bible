...
export function BottomNavigation() {
  return (
    <nav
      ...
      className="absolute inset-x-4 bottom-4 z-10 rounded-2xl border border-[#ddceb8] bg-[#fbf5ea]/96 p-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] shadow-lg backdrop-blur"
    >
