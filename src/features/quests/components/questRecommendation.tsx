    ...
    return (
      <section className="space-y-5" aria-labelledby="quest-complete-heading">
        ...
        <article className="card border border-primary/20 bg-base-100 shadow-sm">
          <div className="card-body items-center gap-3 text-center"><span className="badge badge-primary badge-lg">Reward</span><p className="text-3xl font-bold text-primary">+{selectedQuest.rewardXp} XP</p><p className="font-semibold">+1 Quest Point</p></div>
        </article>
  ...
  if (activeQuest?.status === "active") {
    return (
      <section className="space-y-5" aria-labelledby="active-quest-heading">
        <header className="space-y-2"><p className="text-sm font-semibold uppercase tracking-wide text-primary">Aktive Quest</p><h1 id="active-quest-heading" className="text-2xl font-bold tracking-tight">{selectedQuest.title}</h1><p className="text-sm leading-6 text-base-content/70">Nimm dir den Raum, den diese Aufgabe braucht. Du entscheidest selbst, wann du sie abschließt.</p></header>
