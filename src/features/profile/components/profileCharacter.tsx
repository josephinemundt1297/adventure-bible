  ...
  return (
    <section className="mx-auto flex max-w-md flex-col gap-5" aria-labelledby="character-heading">
      <header className="space-y-2">
        ...
        <h1 id="character-heading" className="app-heading text-2xl font-bold tracking-tight">{name}</h1>
        <p className="text-sm leading-5 text-base-content/70">Dein Abenteuer beginnt mit dem Zustand, in dem du heute ankommst.</p>
      </header>

      <div className="adventure-card rounded-2xl border shadow-sm">
        <div className="card-body items-center gap-4 text-center">
          <ProfileAvatar name={name} size="lg" editable />
          <div>
