...
function ProfileSignedOut() {
  return (
    ...
    >
      <header className="mx-auto w-[88%] space-y-[1.5dvh] pt-[4dvh] text-center">
        <p className="text-[0.75rem] font-bold uppercase tracking-[0.14em] text-primary">
          Neues Abenteuer
        </p>
        <h1
          id="profile-heading"
          className="text-[clamp(1.65rem,6vw,2rem)] font-bold leading-[1.15] tracking-tight text-primary"
        >
          Dein Abenteuer wartet
        </h1>
        <p className="mx-auto w-[94%] text-[0.95rem] leading-6 text-base-content/70">
