  ...
  return (
    <section className="mx-auto flex min-h-full w-full max-w-md flex-col" aria-labelledby="profile-heading">
      <header className="mx-auto w-[86%] space-y-[2dvh] pt-[7dvh] text-center">
        <p className="text-[0.75rem] font-bold uppercase tracking-[0.14em] text-primary">Neues Abenteuer</p>
        <h1 id="profile-heading" className="text-[clamp(1.6rem,6vw,2rem)] font-bold leading-tight tracking-tight text-primary">Dein Abenteuer<br />wartet</h1>
        <p className="mx-auto max-w-[25rem] text-[0.95rem] leading-6 text-base-content/70">Melde dich an oder erstelle<br />dein Konto, damit dein<br />Charakter und dein Fortschritt<br />sicher bei dir bleiben.</p>
      </header>
...
function ProfileSignedIn() {
  ...
  return (
    <section className="mx-auto flex w-full max-w-md flex-col gap-[2.5dvh]" aria-labelledby="account-heading">
      <header className="min-w-0 space-y-[0.75dvh]">
        <p className="text-[0.75rem] font-bold uppercase tracking-[0.14em] text-primary">Dein Konto</p>
        <h1 id="account-heading" className="truncate text-[clamp(1.6rem,6vw,2rem)] font-bold leading-tight tracking-tight text-primary">{name}</h1>
        <p className="text-sm leading-5 text-base-content/70">Dein Konto ist mit deinem Adventure-Bible-Profil verbunden.</p>
      </header>
